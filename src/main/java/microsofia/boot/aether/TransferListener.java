...
public class TransferListener extends AbstractTransferListener{
    ...
    public void transferInitiated( TransferEvent event ){
        ...
        out.println(getDate()+message + ": " + event.getResource().getRepositoryUrl() + event.getResource().getResourceName() );
    }
    ...
    public void transferSucceeded( TransferEvent event ){
        ...
        if ( contentLength >= 0 ){
            ...
            out.println(getDate()+ type + ": " + resource.getRepositoryUrl() + resource.getResourceName() + " (" + len+ throughput + ")" );
        }
    }
